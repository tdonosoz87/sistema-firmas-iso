...
export function Dashboard() {
  ...
  // Disparar recarga de historial y traza de auditoría tras aprobar o crear
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      ...
      {/* 3. Módulo de Auditoría y Registro de Firmantes */}
      <AuditLogModule reloadKey={reloadKey} />

      {/* 4. Historial de Documentos Completados */}
